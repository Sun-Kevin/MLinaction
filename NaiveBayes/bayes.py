...
def loadDataSet():
    ...
    classVec = [0, 1, 0, 1, 0, 1]   # 1 means humiliating words, 0 is fine
...
def trainNB0(trainMatrix, trainCategory):
    ...
    p1Vect = log10(p1Num/p1Denom)              #change to log()
    p0Vect = log10(p0Num/p0Denom)              #change to log()
...
def calcMostFreq(vocabList, fullText):
    ...
    sortedFreq = sorted(freqDict.iteritems(), key=operator.itemgetter(), reverse=True)
